...
@Repository
public interface UserVRepository  extends JpaRepository<UserV, String> {

    @Query("SELECT u FROM UserV u WHERE u.username = :username or u.contactoMail = :username")
    UserV findByUsernameOrMail(@Param("username") String username);
    /*
